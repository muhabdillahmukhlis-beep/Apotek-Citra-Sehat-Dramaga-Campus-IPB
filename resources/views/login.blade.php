...
<body class="min-h-screen flex flex-col font-sans text-[#1A2E1A]">
    ...
    <div class="bg-white rounded-t-[40px] px-8 pt-10 pb-12 shadow-[0_-10px_40px_rgba(0,0,0,0.3)]">
        <div class="w-12 h-1.5 bg-gray-200 rounded-full mx-auto mb-8"></div> <h2 class="font-sora text-2xl font-extrabold text-[#1A2E1A] mb-1">Masuk</h2>
        ...
        <form action="{{ route('login') }}" method="POST" class="space-y-5">
            ...
            <div class="flex items-center justify-between py-2">
                ...
                <a href="#" class="text-sm font-bold text-[#2E7D32]">Lupa Sandi?</a>
            </div>
